...
CLOCK = pygame.time.Clock()  # Essential for regulating the FPS (done under CLOCK.tick() at the
# bottom)
SCREEN = pygame.display.set_mode((800, 800))
pygame.display.set_caption("Jumping in PyGame")

X_POSITION, Y_POSITION = 400, 660  # This is the x and y position of Mario
...
BACKGROUND = pygame.image.load("assets/background.png")  # This is the whole scene which makes up
# Mario's background
